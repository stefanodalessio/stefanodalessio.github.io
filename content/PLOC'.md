...
<img src="0.0_Banner.jpg" style="margin-top:-50px; position:relative; display:block; opacity:0.2; pointer-events:none; width:800px; min-width:800px;">

## [[0.1 Software Installation| 0.1 · SOFTWARE INSTALLATION ]]
<img src="0.1_Banner.jpg" style="margin-top:-50px; position:relative; display:block; opacity:0.2; pointer-events:none; width:800px; min-width:800px;">

## [0.2 · INTRO. TO MAX & STE.SNIPS](0.2-Embodied-Interaction-in-Max-9---An-Introduction-to-the-ste.snips-package) 
<img src="0.2_Banner.jpg" style="margin-top:-50px; position:relative; display:block; opacity:0.2; pointer-events:none; width:800px; min-width:800px;">
