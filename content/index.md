...
If you want to write me, use [**THIS**](https://cargocollective.com/stefanodalessio/CONTACT) contact form.
If you want to be included in my newsletter (4 times a year max, no spam!), just ask for it through the same form. If you are into RSS, you can find a link at the bottom.

If you want to hear some old music, there's an unmaintained **[SOUNDCLOUD](https://soundcloud.com/stefanodalessio)** page of mine.

If you want to connect via socials, I'm experimenting with [Mastodon](https://%40ste@tldr.nettime.org), [Bluesky](https://bsky.app/profile/stefanodalessio.bsky.social).
